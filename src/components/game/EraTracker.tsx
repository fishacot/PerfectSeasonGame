  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-3">
        ...
        <span className="micro-label text-muted opacity-60">{eraDistribution}</span>
        <div className="h-px flex-1 bg-white/10" />
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col leading-none">
                <span
                  className={`font-display text-base tracking-widest ${state === "empty" ? "text-muted" : "text-text"}`}
                >
                  {era}
                </span>
